...
3. There are four routes defined two are POST request for signup and login .
    ...
    For horoscope/today GET routes you need to pass the same token form login and the output you will recieve a horhoroscope details and zodiacsign along with date of birth http://localhost:3000/horoscope/history
